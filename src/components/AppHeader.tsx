...
import logoIronGr from "../assets/logotipo-gr.png"
import {
  Navbar,
  Collapse,
  Typography,
...
export function AppHeader() {
  ...
  return (
    <Navbar className="mx-auto w-screen px-6 py-2 lg:px-8 lg:py-4 text-gray-600 fixed z-50 shadow-md">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        <img src={logoIronGr} alt="logo-irontec-gr" width={"120px"} />
        ...
        <div className="flex items-center gap-x-1">
          ...
          <Button
            variant="gradient"
            size="sm"
            className="hidden bg-gray-600 lg:inline-block"
          >
            <span>Sign in</span>
          </Button>
        </div>
